...
- admin can use the default-on demo walkthrough path, or set `ADMIN_DEMO_ENABLED=false` to hide the showcase entry points
...
- the admin portal includes a dedicated `/showcase` route that explains the product story
